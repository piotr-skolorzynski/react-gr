const BroccoliIcon = ({ color, width, height }) => {
  return (
    <>
      <svg
        version="1.1"
        ...
        width={width}
        height={height}
        viewBox="0 0 45.118 45.118"
        fill={color}
      >
        <g>
          <path
            d="M42.701,29.043c3.148-3.149,3.148-8.257-0.001-11.407c-0.589-0.589-1.261-1.031-1.961-1.4
