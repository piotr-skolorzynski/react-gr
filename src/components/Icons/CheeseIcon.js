const CheeseIcon = ({ color, width, height }) => {
  return (
    <>
      <svg
        version="1.1"
      ...
      >
        <g>
          <polygon
            fill={color}
            points="7.5,107.293 268.817,107.293 199.899,43.566 	"
          />
          <path
            fill={color}
            d="M7.5,107.293V232.75h149.758c0-24.023,19.475-43.498,43.498-43.498s43.498,19.475,43.498,43.498
		h24.563V107.293H7.5z"
          />
          <circle fill="#F9F9F9" cx="49.45" cy="178.833" r="15.965" />
          <circle fill="#F9F9F9" cx="131.873" cy="154.401" r="18.904" />
          <g>
            <path
              fill="#F9F9F9"
              d="M268.817,177.651V126.24c-2.498-0.767-5.151-1.182-7.9-1.182
			c-14.849,0-26.887,12.038-26.887,26.887s12.038,26.887,26.887,26.887C263.666,178.833,266.318,178.418,268.817,177.651z"
            />
            <g>
              <path
                fill="#8e9b04"
                d="M273.908,101.787l-68.917-63.728c-2.004-1.853-4.858-2.471-7.45-1.612L5.287,100.126
              ...
              <path
                fill="#8e9b04"
                d="M49.45,155.368c-12.939,0-23.465,10.526-23.465,23.465s10.526,23.466,23.465,23.466
              ...
              <path
                fill="#8e9b04"
                d="M131.873,127.997c-14.56,0-26.404,11.845-26.404,26.404s11.845,26.404,26.404,26.404
